...
register(id='BabyAI-CustomGoToObjDoorS8N2', entry_point='envs.custom:CustomGoToObjDoorS8N2')
register(id='BabyAI-CustomGoToObjDoorS8N3', entry_point='envs.custom:CustomGoToObjDoorS8N3')
register(id='BabyAI-CustomGoToObjDoorS8N4', entry_point='envs.custom:CustomGoToObjDoorS8N4')
register(id='BabyAI-CustomGoToObjDoorS8N5', entry_point='envs.custom:CustomGoToObjDoorS8N5')
register(id='BabyAI-CustomGoToObjDoorS8N6', entry_point='envs.custom:CustomGoToObjDoorS8N6')
register(id='BabyAI-CustomGoToObjDoorS8N7', entry_point='envs.custom:CustomGoToObjDoorS8N7')
